...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'skynetx007@carnivore.onmicrosoft.com',
  ...
  email: 'mailto:admin@skynetx007.top',
